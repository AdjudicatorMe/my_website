...
const Navbar: React.FC<NavbarProps> = ({ logo, brandName = 'My React App' }) => {
    ...
    <div className="sticky top-4 z-50 px-4">
      <nav className="max-w-6xl mx-auto bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          {/* CTA Button (Desktop) */}
          <div className="hidden md:block">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-all hover:scale-105 shadow-md">
              Get in Touch
            </button>
          </div>
